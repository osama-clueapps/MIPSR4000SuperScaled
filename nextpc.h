...
public:
	...
	int jimm1, jimm2, boffset1, boffset2,jrImm1, jrImm2;
	unsigned int currentj1, currentjr1, currentreturn1, 
		currentjal1, currentj2, currentjr2, currentreturn2, currentjal2;
	nextpc() {
		jumped = false;
	}
	...
	void setInput(int jump1, int jump2, int branch1, int branch2,
		...
		int jal2, unsigned int pc1, unsigned int pc2, int Jimm1, int Jimm2, int branchoffset1, int branchoffset2, int jrImmin1, int jrImmin2) {
